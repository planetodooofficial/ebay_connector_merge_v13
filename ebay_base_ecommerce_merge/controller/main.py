...
class ebay_oauth(http.Controller):
    ...
    @http.route(['/ebay_oauth'], type='json', auth="public", website=True, methods=['POST'])
    def ebay_oauth(self, **kwargs):
        ...
        if resp.status_code == requests.codes.ok:
            ...
            return request.render("ebay_base_ecommerce_merge.thankyou_oauth")
        else:
            return request.render("ebay_base_ecommerce_merge.error")
