...
class update_bulk_carrier_marketplace(models.TransientModel):
    ...
    bulk_carrier_ids = fields.One2many('update.order.wizard', 'bulk_carrier_id', string='Sale order For Update',
                                       default=_default_update_carrier)
    ...
    def update_status(self):
        ...
        for sale_carrier in bulk_carrier_ids:
            ...
            sale_carrier.order_id.write(
                {'carrier_id': sale_carrier.carrier_id.id, 'carrier_tracking_ref': sale_carrier.carrier_tracking_ref})
        #        self._cr.commit()
        ...
        for marketplace_shop in marketplace_shop_list:
            ...
            if marketplace_shop.instance_id.module_id == 'ebay_base_ecommerce_merge':
